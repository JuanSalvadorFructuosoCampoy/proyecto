 ...
 *	La clase "clientes.class.php" es la clase del modelo, que representa a los clientes registrados
*/
...
switch ($_SERVER['REQUEST_METHOD']) {
	...
	/**
	 * Cuando se solicita un DELETE se comprueba que se envíe un id de registro de la tabla. En caso afirmativo se utiliza el método delete() del modelo.
	 */
	case 'DELETE':
