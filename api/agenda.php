<?php
/**
 *	Script que se usa en los endpoints para trabajar con agendas de la tabla agenda_clientes
 *	La clase "agenda.class.php" es la clase del modelo, que representa a un jugador de la tabla
*/
