<?php
/**
 *	Script que se usa en los endpoints para trabajar con registros de la tabla productos_ventas
 *	La clase "productos.class.php" es la clase del modelo, que representa a los productos registrados en las ventas en la base de datos
*/
