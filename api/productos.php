 ...
 *	La clase "productos.class.php" es la clase del modelo, que representa los productos registrados en la base de datos
*/

require 'src/classes/productos.class.php';//Se incluye el archivo de la clase del modelo
